...
pub const Loop = struct {
    ...
    fn cancelInternal(self: *Loop, completion: *Completion, cancel_comp: ?*Cancel) !void {
        ...
        switch (completion.op) {
            ...
            inline .file_open, .file_create, .file_close, .file_read, .file_write, .file_sync, .file_rename, .file_delete, .file_size, .file_stat, .file_stat_path => |op| {
        ...
        switch (completion.op) {
            inline .file_open, .file_create, .file_close, .file_read, .file_write, .file_sync, .file_rename, .file_delete, .file_size, .file_stat, .file_stat_path => |op| {
                ...
                const op_func = switch (op) {
                    ...
                    .file_stat_path => common.fileStatPathWork,
                    else => unreachable,
                };
